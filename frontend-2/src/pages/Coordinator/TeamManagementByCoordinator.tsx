...
import { fetchAllActiveUsers, fetchAllUsersInGroup } from 'src/actions/Auth/authAction';
...
export default function TeamManagementByCoordinator() {
  ...
  const {
    ...
    queryKey: ['all-schedules', date, page, pageSize],
    queryFn: () => getAllSchedulesList(date, page, pageSize),
    staleTime: 60000,
  });
  ...
  return (
    <div className="p-2 md:p-6 lg:p-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full rounded-xl">
        <div className="flex gap-2">
          ...
          <DatePicker
            ...
            format={'DD-MM-YYYY'}
            // disabledDate={(current) => DisablePastDates(current, 30)}
            placeholder="📆 Custom"
      ...
      <DataTable
        ...
        isLoading={isLoading}
        columns={columns}
        tableTitle="All Team Management"
        tableDescription={`Take control of project scheduling for all teams.`}
