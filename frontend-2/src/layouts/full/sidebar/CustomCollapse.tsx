...
const CustomCollapse: React.FC<{
  ...
  return (
    <div className={twMerge('transition-all duration-300')}>
      <div
        className={twMerge(
          'flex relative cursor-pointer mb-1 items-center justify-between rounded-lg px-6 py-[11px] gap-3 text-[15px] leading-[normal] font-normal text-dark/90 nav-cover hover:text-primary   dark:hover:text-primary',
          className,
        )}
        onClick={onClick}
      >
